		...
		<div id="list-player" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nickName" title="${message(code: 'player.nickName.label', default: 'Nick Name')}" />
					
						<g:sortableColumn property="firstName" title="${message(code: 'player.firstName.label', default: 'First Name')}" />
					
						<g:sortableColumn property="handicap" title="${message(code: 'player.handicap.label', default: 'Handicap')}" />
				...
				<g:each in="${playerInstanceList}" status="i" var="playerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: playerInstance, field: "handicap")}</td>
