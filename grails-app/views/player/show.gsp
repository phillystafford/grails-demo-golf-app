		...
		<div id="show-player" class="content scaffold-show" role="main">
			...
			<ol class="property-list player">
				...
				<li class="fieldcontain">
					<span id="nickName-label" class="property-label"><g:message code="player.nickName.label" default="Nick Name" /></span>
				...
				<g:if test="${playerInstance?.handicap}">
				<li class="fieldcontain">
					<span id="handicap-label" class="property-label"><g:message code="player.handicap.label" default="Handicap" /></span>
					
						<span class="property-value" aria-labelledby="handicap-label"><g:fieldValue bean="${playerInstance}" field="handicap"/></span>
